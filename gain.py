...
class load():
    def __init__ (self, training_mode = False, Dropout_rate = 0.5):
        ...
        with tf.variable_scope('fully_connected'):
            ...
            self.D1_cl = tf.layers.dropout(self.h1_cl, rate = Dropout_rate, training = training_mode, name = 'dropout1')
            self.h2_cl = tf.layers.dense(self.D1_cl, 256, activation = tf.nn.relu, name = 'dense2')
            self.D2_cl = tf.layers.dropout(self.h2_cl, rate = Dropout_rate, training = training_mode, name = 'dropout2')
        ...
        with tf.variable_scope('fully_connected', reuse = True):
            ...
            self.D1_masked = tf.layers.dropout(self.h1_masked, rate = Dropout_rate, training = training_mode, name = 'dropout1')
            self.h2_masked = tf.layers.dense(self.D1_masked, 256, activation = tf.nn.relu, name = 'dense2')
            self.D2_masked = tf.layers.dropout(self.h2_masked, rate = Dropout_rate, training = training_mode, name = 'dropout2')
        ...
        with tf.variable_scope('fully_connected', reuse = True):
            ...
            self.D1_ext = tf.layers.dropout(self.h1_ext, rate = Dropout_rate, training = training_mode, name = 'dropout1')
            self.h2_ext = tf.layers.dense(self.D1_ext, 256, activation = tf.nn.relu, name = 'dense2')
            self.D2_ext = tf.layers.dropout(self.h2_ext, rate = Dropout_rate, training = training_mode, name = 'dropout2')
